...
def task_11():
    ...
    for x in range(0, len(grid[0])):
        for i in range (0, len(grid) - 3):
            product = 1
            for j in range(i, i + 4):
                product = product * grid[j][x]
            if product > largestProduct:
                largestProduct = product

    #diagonal down right (same as up left)
    for y in range (0, len(grid) - 3):
        for i in range (0, len(grid[0]) - 3):
            product = 1
            for j in range(0, 4):
                product = product * grid[y + j][i + j]
            if product > largestProduct:
                largestProduct = product

    #diagonal down left (same as up right)
    for y in range (0, len(grid) - 3):
